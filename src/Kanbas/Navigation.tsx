...
function App() {
  ...
  return (
    ...
    //   <div id="wd-kanbas-navigation" style={{ width: 120 }} className="list-group rounded-0 position-fixed bottom-0 top-0 bg-black z-2 d-flex flex-column align-items-center">
