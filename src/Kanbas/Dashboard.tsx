...
export default function Dashboard({
  ...
  <div id="wd-dashboard">
    ...
    <div id="wd-dashboard-courses" className="row">
      ...
      ///////////////////when click Enrollments button show below content//////////////////////////
      // <div className="row"> 
      //   {courses.map((course) => (
      //     <div className="col-md-4 col-sm-6" key={course._id} style={{ width: "300px" }}>
      //       <div className="card rounded-3 overflow-hidden mb-3">
      ...
      //               <button
      //                 className={`btn ${enrollments.some(enrollment => enrollment.user === currentUser._id && enrollment.course === course._id) ? "btn-danger" : "btn-success"}`}
      //                 onClick={(event) => {
      //                   event.preventDefault();
      //                   toggleEnrollment(course._id);
      //                 }}
      //               >
      //                 {enrollments.some(enrollment => enrollment.user === currentUser._id && enrollment.course === course._id) ? "Unenroll" : "Enroll"}
      //               </button>
      //           </div>
      //         </Link>
      //       </div>
